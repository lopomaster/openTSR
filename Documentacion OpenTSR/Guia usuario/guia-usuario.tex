...
\begin{itemize}
\item \textbf{Conectar:}\\
Icono representativo:\quad  \icontext{.4}{.5}{icono_conectar.png} \\
...
Icono representativo:\quad  \icontext{.4}{.5}{icono_desconectar.png} \\
...
Icono representativo:\quad  \icontext{.4}{.3}{icono_laser_off.png} \\
...
Icono representativo:\quad  \icontext{.4}{.3}{icono_laser_on.png} \\
...
\item \textbf{Tomar fotografía:}\\
 Icono representativo:\quad  \icontext{.4}{.15}{icono_foto.png} \\
Acción: toma una fotografía de la imagen visionada por la cámara.

\item \textbf{Velocidad alta:}\\
 Icono representativo:\quad  \icontext{.4}{.15}{icono_velocidad_alta.png} \\
...
Icono representativo:\quad  \icontext{.4}{.15}{icono_velocidad_baja.png} \\
